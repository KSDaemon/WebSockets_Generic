...
static int base64_decode_block_signed(const int8_t *code_in, const int length_in,
                                      int8_t *plaintext_out, base64_decodestate *state_in) {
        ...
        while (1) {
            ...
            case step_d:
                do {
                    ...
                    fragment = (int8_t)base6 4_decode_value_signed(*codechar++);
                } while (fragment < 0);
...
static int base64_decode_chars_signed(const int8_t *code_in, const int length_in,
...
int base64_decode_block(const char *code_in, const int length_in, char *plaintext_out,
    ...
    return base64_decode_block_signed((int8_t *)code_in, length_in, (int8_t *)plaintext_out,
                                      state_in);
}
