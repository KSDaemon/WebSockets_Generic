...
__attribute__((weak)) void __throw_bad_function_call() {
...
#define WEBSOCKETS_YIELD_MORE() delay(1)
       ...
       defined(STM32L4) || defined(STM32H7) || defined(STM32G0) || defined(STM32G4) ||             \
...
#elif (defined(NRF52840_FEATHER) || defined(NRF52832_FEATHER) || defined(NRF52_SERIES) ||          \
       defined(ARDUINO_NRF52_ADAFRUIT) || defined(NRF52840_FEATHER_SENSE) ||                       \
       defined(NRF52840_ITSYBITSY) || defined(NRF52840_CIRCUITPLAY) || defined(NRF52840_CLUE) ||   \
...
#define WEBSOCKETS_YIELD_MORE() delay(1)
       ...
       defined(ARDUINO_SAMD_MKRFox1200) || defined(ARDUINO_SAMD_MKRWAN1300) ||                     \
       defined(ARDUINO_SAMD_MKRWAN1310) || defined(ARDUINO_SAMD_MKRGSM1400) ||                     \
       defined(ARDUINO_SAMD_MKRNB1500) || defined(ARDUINO_SAMD_MKRVIDOR4000) ||                    \
       defined(__SAMD21G18A__) || defined(ARDUINO_SAMD_CIRCUITPLAYGROUND_EXPRESS) ||               \
       defined(__SAMD21E18A__) || defined(__SAMD51__) || defined(__SAMD51J20A__) ||                \
...
typedef enum { WSC_NOT_CONNECTED, WSC_HEADER, WSC_BODY, WSC_CONNECTED } WSclientsStatus_t;
...
typedef struct {
    ...
    uint8_t disconnectTimeoutCount = 0; // after how many subsequent pong timeouts disconnect will
                                        // happen, 0 means "do not disconnect"
...
class WebSockets {
  protected:
    ...
    void clientDisconnect(WSclient_t *client, uint16_t code, char *reason = NULL,
                          size_t reasonLen = 0);
    ...
    bool sendFrame(WSclient_t *client, WSopcode_t opcode, uint8_t *payload = NULL,
                   size_t length = 0, bool fin = true, bool headerToPayload = false);
    ...
    void enableHeartbeat(WSclient_t *client, const uint32_t &pingInterval,
                         const uint32_t &pongTimeout, const uint8_t &disconnectTimeoutCount);
