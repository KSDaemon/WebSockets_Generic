/****************************************************************************************************************************
  Teensy_WebSocketClient_EthernetENC.ino
  For Teensy boards using ENC28J60 Ethernet Shield/Module and EthernetENC library
...
void setup()
{
  ...
  Serial.print("\nStart Teensy_WebSocketClient_EthernetENC on ");
